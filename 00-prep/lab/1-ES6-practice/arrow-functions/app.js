...
//this has no context with arrow notation.  I converted it back to original in order to make it work
console.log(joe);
...
//this has no context. neither does prototype...
...
// this referes to the instance of Joe. name age and hometown with old function and then this has no context with arrow
// 2. What is "this" when joe.scopeArrow() is invoked?
// this referes to the instance of Joe. name age and hometown with old function and then this has no context with arrow
// 3. Explain why "this" is different when an arrow function is used.
// arrow function removes context. therefre it is not useful as a generator
